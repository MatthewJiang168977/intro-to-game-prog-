...
private:
    ...
    float mFlyerOriginY    = 0.0f;
    float mFlyerAmplitude  = 80.0f;
    float mFlyerTimer      = 0.0f;
    float mFlyerFrequency  = 2.0f;
...
public:
    ...
    void setAIType(AIType newType)
        { mAIType = newType;                       }
    void setFlyerOriginY(float y)
        { mFlyerOriginY = y;                       }
    void setFlyerAmplitude(float amp)
        { mFlyerAmplitude = amp;                   }
    void setFlyerFrequency(float freq)
        { mFlyerFrequency = freq;                  }
};
