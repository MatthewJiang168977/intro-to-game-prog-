...
void LevelA::initialise()
{
    ...
    // ENEMIES 
    mGameState.enemyCount = LEVELA_ENEMY_COUNT;
    ...
    mGameState.enemies[0].setPosition({mOrigin.x - 900.0f, mOrigin.y - 150.0f});
...
void LevelA::update(float deltaTime)
{
    ...
    if (mGameState.player->checkEnemyCollision(mGameState.enemies, mGameState.enemyCount))
    {
        ...
        {
            mGameState.nextSceneID = 5; // LoseScene
        }
        else
        {
